...
public abstract class ClientIntSettingAttribute(ConfigEntry<bool> configEntry, Color? onColor = null, Color? offColor = null) : ClientSettingAttribute(configEntry)
{
