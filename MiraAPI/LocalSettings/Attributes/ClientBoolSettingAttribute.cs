...
public abstract class ClientBoolSettingAttribute(ConfigEntry<bool> configEntry, Color? onColor = null, Color? offColor = null) : ClientSettingAttribute(configEntry)
{
